...
module.exports = {
    ...
    formatsSelector: (state) => get(state, "catalog.supportedFormats") || [{name: "csw", label: "CSW"}, {name: "wms", label: "WMS"}, {name: "wmts", label: "WMTS"}, {name: "tms", label: "TMS"}, {name: "tileprovider", "label": "Tile Provider"}],
