...
export const getTotalUserGroups = state => state?.usergroups?.grid?.total;
...
export const getCurrentPage = state => state?.usergroups?.grid?.page ?? 1;
export const getSearch = state => state?.usergroups?.grid?.search;
