...
export const getTotalUsers = state => state?.users?.grid?.total;
...
export const getCurrentPage = state => state?.users?.grid?.page ?? 1;
export const getSearch = state => state?.users?.grid?.search;
