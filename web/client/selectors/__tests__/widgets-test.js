...
describe('widgets selectors', () => {
    it('getFloatingWidgets', () => {
        ...
        expect(getFloatingWidgets(state)).toBeTruthy();
        expect(getFloatingWidgets(state)[0]).toBeTruthy();
    ...
    it('getFloatingWidgetsLayout', () => {
        ...
        expect(getFloatingWidgetsLayout(state)).toBeTruthy();
        expect(getFloatingWidgetsLayout(state)[0]).toBeTruthy();
        expect(getFloatingWidgetsLayout(state)[0].title).toBe("TEST");
    });
    it('getFloatingWidgets', () => {
        const state = set(`widgets.containers[${DEFAULT_TARGET}].widgets`, [{ title: "TEST" }], {});
        expect(getDashboardWidgets(state)).toBeTruthy();
        expect(getDashboardWidgets(state)[0]).toBeTruthy();
        expect(getDashboardWidgets(state)[0].title).toBe("TEST");
    });
    it('getFloatingWidgetsLayout', () => {
        const state = set(`widgets.containers[${DEFAULT_TARGET}].layouts`, [{ title: "TEST" }], {});
        expect(getDashboardWidgetsLayout(state)).toBeTruthy();
        expect(getDashboardWidgetsLayout(state)[0]).toBeTruthy();
        expect(getDashboardWidgetsLayout(state)[0].title).toBe("TEST");
    });
    it('getEditingWidget', () => {
        const state = set(`widgets.builder.editor`, { title: "TEST" }, {});
        expect(getEditingWidget(state)).toBeTruthy();
    ...
    it('getEditingWidgetLayer', () => {
        ...
        expect(getEditingWidgetLayer(state)).toBeTruthy();
    ...
    it('getEditorSettings', () => {
        ...
        expect(getEditorSettings(state)).toBeTruthy();
    ...
    it('returnToFeatureGridSelector', () => {
        ...
        expect(returnToFeatureGridSelector(state)).toBeTruthy();
    ...
    it('getWidgetAttributeFilter', () => {
        ...
        expect(widgetFilter).toBeTruthy();
    ...
    it('getWidgetLayer', () => {
        ...
        expect(getWidgetLayer(tocLayerState)).toBeTruthy();
        ...
        expect(getWidgetLayer(dashboardNoLayer)).toBeFalsy();
    ...
    it('availableDependenciesSelector', () => {
        ...
        expect(availableDependenciesSelector(state)).toBeTruthy();
    ...
    it('availableDependenciesForEditingWidgetSelector for map', () => {
        ...
        expect(availableDeps).toBeTruthy();
