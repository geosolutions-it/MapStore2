 ...
 * @param {string} mode replace or merge, replace is default and it replace the value for the key,
 ...
 */
const updateWidgetProperty = (id, key, value, target = DEFAULT_TARGET, mode = "replace") => ({
