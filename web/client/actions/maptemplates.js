...
export const SET_LOCALCONFIG_TEMPLATES = 'MAPTEMPLATES:SET_LOCALCONFIG_TEMPLATES';
export const setLocalConfigTemplates = (templates) => ({ type: SET_LOCALCONFIG_TEMPLATES, templates});
