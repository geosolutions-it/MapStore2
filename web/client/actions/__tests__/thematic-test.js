...
describe('Test correctness of the themtic actions', () => {
    it('loadFields', () => {
        ...
        expect(retval.layer).toBeTruthy();
    ...
    it('fieldsLoaded', () => {
        ...
        expect(retval.layer).toBeTruthy();
        expect(retval.layer.name).toBe('mylayer');
        expect(retval.fields).toBeTruthy();
    ...
    it('loadClassification', () => {
        ...
        expect(retval.layer).toBeTruthy();
        expect(retval.layer.name).toBe('mylayer');
        expect(retval.params).toBeTruthy();
    ...
    it('classificationLoaded', () => {
        ...
        expect(retval.layer).toBeTruthy();
        expect(retval.layer.name).toBe('mylayer');
        expect(retval.classification).toBeTruthy();
    ...
    it('resetInvalidInput', () => {
        ...
        expect(retval.message).toBeFalsy();
        expect(retval.params).toBeFalsy();
    });
});
