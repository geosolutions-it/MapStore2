...
const enhanceChartWidget = require('../widgets/enhancers/chartWidget');
const wpsChart = require('../widgets/enhancers/wpsChart');
const dependenciesToFilter = require('../widgets/enhancers/dependenciesToFilter');
...
const ChartWidget = dependenciesToFilter(wpsChart(enhanceChartWidget(require('../widgets/widget/ChartWidget'))));
