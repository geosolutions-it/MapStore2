...
class CesiumMap extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (prevProps && (!isEqual(this.props.mapOptions.showSkyAtmosphere, prevProps?.mapOptions?.showSkyAtmosphere))) {
            this.map.scene.skyAtmosphere.show = this.props.mapOptions.showSkyAtmosphere;
        }
        if (prevProps && (!isEqual(this.props.mapOptions.showGroundAtmosphere, prevProps?.mapOptions?.showGroundAtmosphere))) {
            this.map.scene.globe.showGroundAtmosphere = this.props.mapOptions.showGroundAtmosphere;
        }
        if (prevProps && (!isEqual(this.props.mapOptions.enableFog, prevProps?.mapOptions?.enableFog))) {
            this.map.scene.fog.enabled = this.props.mapOptions.enableFog;
        }
        if (prevProps && (!isEqual(this.props.mapOptions.depthTestAgainstTerrain, prevProps?.mapOptions?.depthTestAgainstTerrain))) {
