...
var DrawHole = function(options = {}) {
    ...
    let geometryFn;
    const geomFn = options.geometryFunction;
    if (geomFn) {
        geometryFn = function(c, g) {
            return geomFn(c, self._geometryFn(c, g));
        };
    } else {
 ...
 * @api stable
 */
DrawHole.prototype.setMap = function(map) {
 ...
 * @api stable
 */
DrawHole.prototype.setActive = function(b) {
 ...
 */
DrawHole.prototype.removeLastPoint = function() {
 ...
 * @return {ol.Feature}
 */
DrawHole.prototype.getPolygon = function() {
 ...
 * @private
 */
DrawHole.prototype._startDrawing = function(e) {
 ...
 * @private
 */
DrawHole.prototype._finishDrawing = function(e) {
 ...
 * @private
 */
DrawHole.prototype._geometryFn = function(coordinates, geometry) {
