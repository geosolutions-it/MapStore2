...
describe('ContentWrapper component', () => {
    ...
    it('test classes generated from default props', () => {
        ...
        const DEFAULT_FIT_CLASS_NAME = 'ms-size-cover';
        ReactDOM.render(<ContentWrapper type="text"/>, document.getElementById("container"));
        const container = document.getElementById('container');
        const el = container.querySelector('.ms-content');
        expect(el).toExist();
        expect(el.getAttribute('class')).toBe(`ms-content ms-content-text ${DEFAULT_THEME_CLASS_NAME} ${DEFAULT_ALIGN_CLASS_NAME} ${DEFAULT_SIZE_CLASS_NAME} ${DEFAULT_FIT_CLASS_NAME}`);
    });
    it('test classes generated from theme prop', () => {
        ...
        const el = container.querySelector('.ms-content');
        expect(el).toExist();
        expect(el.getAttribute('class')).toBe(`ms-content ms-content-text ${THEME_CLASS_NAME} ${DEFAULT_ALIGN_CLASS_NAME} ${DEFAULT_SIZE_CLASS_NAME} ${DEFAULT_FIT_CLASS_NAME}`);
    });
    it('test classes generated from align prop', () => {
        ...
        const el = container.querySelector('.ms-content');
        expect(el).toExist();
        expect(el.getAttribute('class')).toBe(`ms-content ms-content-text ${DEFAULT_THEME_CLASS_NAME} ${ALIGN_CLASS_NAME} ${DEFAULT_SIZE_CLASS_NAME} ${DEFAULT_FIT_CLASS_NAME}`);
    });
    it('test classes generated from size prop', () => {
        ...
        const el = container.querySelector('.ms-content');
        expect(el).toExist();
        expect(el.getAttribute('class')).toBe(`ms-content ms-content-text ${DEFAULT_THEME_CLASS_NAME} ${DEFAULT_ALIGN_CLASS_NAME} ${SIZE_CLASS_NAME} ${DEFAULT_FIT_CLASS_NAME}`);
    });
    it('test classes generated from size prop', () => {
        const FIT = 'fit';
        const DEFAULT_THEME_CLASS_NAME = 'ms-bright';
        ...
        const DEFAULT_FIT_CLASS_NAME = `ms-size-${FIT}`;
        ReactDOM.render(<ContentWrapper type="text" fit={FIT}/>, document.getElementById("container"));
        const container = document.getElementById('container');
        const el = container.querySelector('.ms-content');
        expect(el).toExist();
        expect(el.getAttribute('class')).toBe(`ms-content ms-content-text ${DEFAULT_THEME_CLASS_NAME} ${DEFAULT_ALIGN_CLASS_NAME} ${SIZE_CLASS_NAME} ${DEFAULT_FIT_CLASS_NAME}`);
