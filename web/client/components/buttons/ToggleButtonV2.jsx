...
var ToggleButton = React.createClass({
    ...
    renderNormalButton() {
        return (
            <Button id={this.props.id} {...this.props.btnConfig} onClick={this.props.onClick} bsStyle={this.props.pressed ? this.props.pressedStyle : this.props.defaultStyle} style={this.props.style}>
    ...
    renderImageButton() {
        return (
            <ImageButton id={this.props.id} image={this.props.image} onClick={this.props.onClick} style={this.props.style}/>
        );
    },
    addTooltip(btn) {
        return (
