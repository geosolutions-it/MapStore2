...
describe('exportableWidget enhancer', () => {
    ...
    it('callbacks', () => {
        ...
        expect(spyCSV.mock.calls[0][0].data).toBe(sampleData);
        expect(spyCSV.mock.calls[0][0].title).toBe("widget title");
        ...
        expect(spyImage.mock.calls[0][0].widgetDivId).toBe("widget-chart-ID");
        expect(spyImage.mock.calls[0][0].title).toBe("widget title");
    });
