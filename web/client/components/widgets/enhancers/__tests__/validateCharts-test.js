...
import validateCharts from '../validateCharts';

describe.only('validateCharts enhancer', () => {
    beforeEach((done) => {
    ...
    it('validateCharts data retrival', (done) => {
        const Sink = validateCharts(createSink( ({data, loading} = {}) => {
            if (!loading) {
                expect(data).toExist();
    ...
    it('validateCharts error management', (done) => {
        const Sink = validateCharts(createSink( ({error, loading} = {}) => {
            if (!loading && error) {
