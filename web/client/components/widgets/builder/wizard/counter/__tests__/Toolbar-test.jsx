...
describe('CounterWizard Toolbar component', () => {
    ...
    it('step 0', () => {
        ...
        expect(buttons[0].querySelector('.glyphicon-filter')).toBeTruthy();
        // filter should not enabled because valid means also that
        // there are some attributes
        expect(buttons[0].disabled).toBe(true);
        expect(buttons[1].querySelector('.glyphicon-arrow-right')).toBeTruthy();
    ...
    it('step 1', () => {
        ...
        expect(buttons[1].querySelector('.glyphicon-floppy-disk')).toBeTruthy();
    });
    it('step buttons', () => {
