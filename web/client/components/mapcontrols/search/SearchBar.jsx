...
class SearchBar extends React.Component {
    ...
    renderAddonAfter = () => {
        ...
        const search = <Glyphicon className={!!this.props.isSearchClickable ? "magnifying-glass clickable" : "magnifying-glass"} glyph={this.props.searchIcon} key="searchbar_search_glyphicon" onClick={this.search}/>;
