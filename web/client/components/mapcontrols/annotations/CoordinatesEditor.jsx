            ...
            <Col xs={12}>
                <FormGroup validationState={this.getValidationStateText(this.props.properties.valueText)}>
                    ...
                    <FormControlLocalized
                        ...
                        name="text"
                        placeholder="annotations.editor.placeholder.text"
                        onChange={e => {
        ...
        const buttons = [
            {
                ...
                (
                    <FormGroup
                        ...
                        display: "inline-flex",
                        alignItems: "baseline"}}>
                        <ControlLabel style={{marginRight: 5}}><Message msgId="annotations.editor.format"/></ControlLabel>{  }
                        <FormControlLocalized componentClass="select"
