...
describe("test FeatureList component", () => {
    ...
    it('test render geometries list with invalid feature selected', () => {
        ...
        ReactDOM.render(<FeaturesList editing={geometriesList} selected={selected} defaultPointType={'symbol'}/>, document.getElementById("container"));
        const container = document.getElementById('container');
        expect(container).toBeTruthy();
    ...
    it('test render geometries list with invalid feature selected', () => {
        ReactDOM.render(<FeaturesList editing={geometriesList} defaultPointType={'symbol'}/>, document.getElementById("container"));
        const container = document.getElementById('container');
        expect(container).toBeTruthy();
        const selectedCard = container.querySelectorAll(".ms-selected");
        const disabledCards = container.querySelectorAll(".ms-disabled");
