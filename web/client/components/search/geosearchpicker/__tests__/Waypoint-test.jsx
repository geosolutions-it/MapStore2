...
describe('Waypoint Component', () => {
    ...
    it('should render waypoint number', () => {
        ReactDOM.render(<WaypointComponent {...defaultProps} />, container);

        const waypointNumber = container.querySelector('.ms-secondary-colors');
        expect(waypointNumber).toBeTruthy();
        expect(waypointNumber.textContent).toContain('1');
    });
