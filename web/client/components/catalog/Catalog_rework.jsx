                ...
                {this.isViewMode(this.props.mode) ? (
                    <Form>
                        ...
                        <FormGroup controlId="service" key="service">
                            <InputGroup>
                                <ReactAutocomplete
                                    wrapperStyle={{disply: "block"}}
                                    wrapperProps={{className: "catalog-autocomplete"}}
                                    inputProps={{className: "form-control", placeholder: "Type the service"}}
                                    items={services}
                                    ...
                                    onChange={(e) => this.props.onChangeSelectedService(e.target.value)}
                                    onSelect={(e) => this.props.onChangeSelectedService(e)}
                                  />

                                <InputGroup.Addon onClick={() => this.props.onChangeCatalogMode("edit")}>
