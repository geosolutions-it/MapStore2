...
describe('Test the EditorUtils', () => {
    ...
    it('IMAGE entity with no alignment', () => {
        ...
        const expectedResult = '<img class="img-template-gfi" src="http://src" alt="alternative" style="height: 128px; width: 128px; display: block; margin: 0 auto 0 auto;"/>';
    ...
    it('IMAGE entity with alignment=left', () => {
        ...
        const expectedResult = '<img class="img-template-gfi" src="http://src" alt="alternative" style="height: 128px; width: 128px; float: left;"/>';
        const result = customEntityTransform(entity);
    ...
    it('IMAGE entity with alignment=right', () => {
        ...
        const expectedResult = '<img class="img-template-gfi" src="http://src" alt="alternative" style="height: 128px; width: 128px; float: right;"/>';
        const result = customEntityTransform(entity);
