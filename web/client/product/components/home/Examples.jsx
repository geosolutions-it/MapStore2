            ...
            <Carousel>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="#/viewer/leaflet/0" bsStyle="info btn-lg" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="examples/3dviewer" bsStyle="info btn-lg" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="examples/mouseposition" bsStyle="info btn-lg" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="examples/scalebar" bsStyle="info btn-lg" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="examples/layertree" bsStyle="info btn-lg" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="examples/queryform" bsStyle="info btn-lg" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="examples/featuregrid" bsStyle="info btn-lg" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="examples/print" bsStyle="info btn-lg" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="examples/plugins" bsStyle="info btn-lg" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="examples/rasterstyler" bsStyle="info btn-lg" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
            </Carousel>
        </Panel>);
