            ...
            <Carousel>
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="#/viewer/leaflet/0" bsStyle="info" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
                ...
                <CarouselItem>
                  ...
                  <div className="carousel-caption">
                    ...
                    <Button href="examples/queryform" bsStyle="info" target="_blank"><I18N.Message msgId="home.open" /></Button>
                  </div>
                </CarouselItem>
                <CarouselItem>
