...
const {
    saveDetails, SET_DETAILS_CHANGED, MAPS_LIST_LOADING,
...
describe('maps Epics', () => {
    ...
    //                 searchText: '',
    //                 opts: {
    //                     baseUrl: "base/web/client/test-resources/geostore/",
    //                     params: {start: 0, limit: 12 }
    //                 }
    //             }
    //         ];
    ...
    it('test getMapsResourcesByCategoryEpic ', done => {
        testEpic(addTimeoutEpic(getMapsResourcesByCategoryEpic), 1, getMapResourcesByCategory('MAP', 'test', {
            baseUrl: "base/web/client/test-resources/geostore/extjs/search/category/MAP/test.json#",
            params: {start: 0, limit: 12 }
        }), actions => {
            console.log(actions);
            done();
