...
describe('Test the mapConfig reducer', () => {
    it('creates a configuration object from loaded config', () => {
        ...
        expect(state.map.zoom).toBeTruthy();
        expect(state.map.center).toBeTruthy();
        expect(state.map.center.crs).toBeTruthy();
    ...
    it('checks if empty background layer type is changed accordingly', () => {
        ...
        expect(state2.layers).toBeTruthy();
    ...
    it('get map info', () => {
        ...
        expect(state.map).toBeTruthy();
        expect(state.map.info).toBeFalsy();
        ...
        expect(state.map).toBeTruthy();
        expect(state.map.info).toBeTruthy();
