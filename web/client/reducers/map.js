...
var {CHANGE_MAP_VIEW, CHANGE_MOUSE_POINTER,
    ...
    TOGGLE_UNSAVED_MAP_CHANGES_DIALOG, REGISTER_EVENT_LISTENER, UNREGISTER_EVENT_LISTENER, MOUSE_MOVE_MAP_EVENT, MOUSE_MOVE_OVER_TOOLS} = require('../actions/map');
...
function mapConfig(state = {eventListeners: {}}, action) {
    ...
    case MOUSE_MOVE_MAP_EVENT: {
        return assign({}, state, {position: action.position, mouseMoveOverTools: false});
    }
    case MOUSE_MOVE_OVER_TOOLS: {
        return assign({}, state, {mouseMoveOverTools: true});
    }
    default:
        return state;
    }
