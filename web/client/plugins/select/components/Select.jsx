...
import { isSelectQueriable, filterLayerForSelect } from '../../../selectors/select';
                        ...
                        <>
                            {selectionData.error ? (
                                ...
                                <div className="features-count-displayer">
                                    {selectionData.features && selectionData.features.length === maxFeatureCount && <NodeTool tooltip={<Message msgId="select.hasReachMaxCount"/>} /* tooltip={"ouech"} */  glyph="exclamation-mark"/>}
                    ...
                    treeHeader={
                        <li className={'ms-node ms-node-layer tree-header'}>
                            <NodeHeader
                                ...
                                afterTitle={<Message msgId="select.featuresCount" className={'features-count'}/>}
                            />
                        </li>
                    }
                />
