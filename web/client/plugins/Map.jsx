...
let plugins;
const {handleCreationLayerError, handleCreationBackgroundError, resetMapOnInit, updateMapLayoutBounds} = require('../epics/map');
/**
...
module.exports = {
    ...
    epics: assign({}, {handleCreationLayerError, handleCreationBackgroundError, resetMapOnInit, updateMapLayoutBounds})
};
