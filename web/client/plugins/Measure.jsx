...
const MeasurePlugin = connect(
    ...
    return (
        <div className={props.mapType !== MapLibraries.CESIUM && props?.defaultOptions?.showCoordinateEditor ? "measure-container measure-coords-editor" : "measure-container"} style={{top: coordsAeronauticalEnabled ? 88 : 48}} data-ms-id="measure-container">
            {
