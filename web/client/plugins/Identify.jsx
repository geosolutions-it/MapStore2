...
const identifyIndex = compose(
    connect(
        createSelector(indexSelector, isLoadedResponseSelector, (state) => state.browser && state.browser.mobile, (state) => state.localConfig, (index, loaded, isMobile, localConfig) => ({ index, loaded, isMobile, localConfig })),
        {
            setIndex: changePage
        }
    )
