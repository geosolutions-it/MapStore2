 ...
 * @prop {object} [dateFormats] object containing custom formats for date/time attribute types. Once specified, custom formats will be applied for specific attribute types in Table widget. Following keys are supported: `date-time`, `date`, `time`. Example:
 * ```
 * "dateFormats": {
