...
const {mapSelector, mapLayoutBoundsValuesSelector, mapLayoutBoundsSelector} = require('../selectors/map');
...
const backgroundSelector = createSelector([
    ...
    (map, layers, controls, drawer, maptype, currentLayer, tempLayer, layout) => ({
        ...
        style: mapLayoutBoundsValuesSelector(layout, {left: true, bottom: true})
    }));
