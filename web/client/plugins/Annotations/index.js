...
/**
  ...
  * @prop {array} format decimal or aeronautical degree for coordinates
  ...
  * @prop {boolean} geodesic **deprecated** draw geodesic annotation. By default geodesic is true (Currently applicable only for Circle annotation)
  * @prop {array} fields **deprecated** Available annotation fields (title and description are mandatory). A list of object specifying:
