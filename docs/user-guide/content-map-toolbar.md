...
* **Hide caption** button <img src="../img/button/hide-caption.jpg" class="ms-docbutton"/> to show/hide the description under the image: this button is present only if a description has been provided for the map resource (see the [Media Editor](media-editor-window.md) tool for example)
