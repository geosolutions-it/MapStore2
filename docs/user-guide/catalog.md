...
!!! Note
    To properly display COG in your MapStore map, it is necessary to add the reference system definition supported by the GOG in the MapStore [projectionDefs configuration](https://docs.mapstore.geosolutionsgroup.com/en/latest/developer-guide/local-config/#projectiondefs-configuration)
