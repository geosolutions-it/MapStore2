...
Thanks to the new improvements made to the **Measure tool**, when [3D Navigation](side-bar.md#3d-navigation) is enabled, the editor has the ability to perform distance, area, point coordinates, height from terrain, angle and slope measurements on the 3D map.
