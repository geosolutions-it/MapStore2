...
!!! note
    Creating widgets for a layer is accessible from the *TOC* and the *Attribute Table* by clicking on this icon <img src="../img/button/widgets.jpg" style="max-width:20px;"/> and was already treated in the [Widgets](widgets.md) section.

* **Open** a new map.
* **Add** a vector layer (e.g. USA Population).
* **Select** the layer.
* **Click** on the *Open Attribute Table* icon <img src="../img/button/attributes-table.jpg" style="max-width:20px;"/>, you will note that the table has 49 items (rows).

The attribute table will open showing the data table and a set of functionalities.

<img src="../img/attributes-table/attributes-table-1.jpg" style="max-width:600px;"/>
...
* **Open** the *Attribute Table* of a layer (e.g '`Lakes, Mountains and Forest`')
    ...
    <img src="../img/attributes-table/attribute-table-editing-layer.jpg" />

* **Click** on the *Edit mode* icon <img src="../img/button/editing-button.jpg" style="max-width:25px;" /> to start an editing session
...
<img src="../img/attributes-table/edit-mode.jpg" />

Through the *Quit edit mode* button <img src="../img/button/quit-edit-mode-button.jpg" style="max-width:25px;" /> you can stop the editing session to make the other functionalities available again.

### Creation of features

Once the *Edit mode* is enabled, you can add new features to your layers as described in the following steps:

* **Click** on the *Add New Feature* icon <img src="../img/button/add-new-feature-icon.jpg" style="max-width:25px;" /> to create a new row in the *Attribute Table* and fill out its fields

    <img src="../img/attributes-table/add-new-feature-attributes.jpg" />
    ...
    <br>
    The *Missing geometry* exclamation point <img src="../img/button/missing-geometry-exclamation-point.jpg" style="max-width:25px;" /> in the second column of the *Attibute Table* means that the feature doesn't have a geometry yet. You can add it later or draw it on the map before saving.

    <img src="../img/attributes-table/missing-geometry.jpg" style="max-width:300px;" />

    If you want to save the changes made until now, **Click** on the *Save changes* icon <img src="../img/button/save-changes.jpg" style="max-width:25px;" />.
    <br>
    To undo your changes and exit from the *Add New Feature* process **Click** on the *Cancel changes* icon <img src="../img/button/cancel-changes.jpg" style="max-width:25px;" />.

* **Click** on the *Add a shape to existing geometry* icon <img src="../img/button/add-shape-icon.jpg" style="max-width:25px;" /> to draw the shape on the map.
    ...
    <img src="../img/attributes-table/drawing-polygon-shape.gif" />

    You can delete the whole shape with the *Delete geometry* button <img src="../img/button/delete-geometry-button.jpg" style="max-width:25px;" />.
    <br>

* **Click** on the *Save changes* button <img src="../img/button/save-changes.jpg" style="max-width:25px;" /> to commit your changes.
...
<img src="../img/attributes-table/drawing-line-shape.gif" />

For ***Points*** geometries (e.g. '`Points of Interest`' layer) you can see a marker <img src="../img/attributes-table/marker.jpg" style="max-height:25px;" /> on your mouse cursor, a point is drawn down when you click on the map.

<img src="../img/attributes-table/drawing-point-shape.gif" />

### Updating of features

If you want to update an existing feature, start an editing session by clicking the *Edit mode* icon <img src="../img/button/editing-button.jpg" style="max-width:25px;" /> button and follow these steps:
...
* If you want to update the geometry shape, you can:
    ...
    * **click** on the *Add a shape to the existing geometry* button <img src="../img/button/add-shape-icon.jpg" style="max-width:25px;" /> to draw a new shape

* **Click** on the **Save changes** button <img src="../img/button/save-changes.jpg" style="max-width:25px;" /> to commit your changes.

<img src="../img/attributes-table/update-polygon-shape.gif" />
...
* **Click** on the *Delete selected features* button <img src="../img/button/delete-features-button.jpg" style="max-width:25px;" /> to trigger the deletion of the selected features

* **Confirm** your choice in the subsequent dialog by clicking on '`Delete`' or return back by clicking '`Close`'

<img src="../img/button/delete-line-shape.gif" />
...
<p><img src="../img/attributes-table/attribute-table-quick-filter.jpg" style="max-width:620px;"/></p>
...
<p><img src="../img/attributes-table/attribute-table-quick-filter-1.jpg" style="max-width:620px;"/></p>
...
<p><img src="../img/attributes-table/attribute-table-quick-filter-2.jpg" style="max-width:620px;"/></p>
...
<p><img src="../img/attributes-table/attribute-table-quick-filter-3.jpg" style="max-width:620px;"/></p>

* Filtering states with male population **Male < 2000,0000**
<p><img src="../img/attributes-table/attribute-table-quick-filter-4.jpg" style="max-width:620px;"/></p>
...
* **Click** on the *Advanced Search* icon <img src="../img/button/filter-icon.jpg" style="max-width:25px;" />.

The filtering page will open showing *Filters Types*.

<p align = "center" ><img src="../img/attributes-table/filter-types.jpg" style="max-width:500px;"/></p>
...
* **Click** on the *Hide/Show columns* button <img src="../img/button/hide-show.jpg" style="max-width:25px;" />.

* **Switch off** the fields leaving only the **STATE_NAME**, **PERSONS** and **EMPLOYED**.

<p align = "center" ><img src="../img/attributes-table/hide-show-1.jpg" style="max-width:620px;"/></p>

Now, let us set some filters.

* **Click** on the <img src="../img/button/++.jpg" style="max-width:20px;"/> button to add a condition.

<p align = "center" ><img src="../img/attributes-table/attribute-filter-1.jpg" style="max-width:500px;"/></p>

* **Set** the following condition for example; **Persons >= 6 000 000**.

<p align = "center" ><img src="../img/attributes-table/attribute-filter-5.jpg" style="max-width:620px;"/></p>
...
<p align = "center" ><img src="../img/attributes-table/attribute-filter-2.jpg" style="max-width:620px;"/></p>
...
* **Click** on the <img src="../img/button/sync.jpg" style="max-width:20px;"/> icon to synchronize the map with the filter.

<p align = "center" ><img src="../img/attributes-table/attribute-filter-3.jpg" style="max-width:620px;"/></p>

Now let us add other conditions:

* **Click** again on the *Advanced Search* icon <img src="../img/button/filter-icon.jpg" style="max-width:25px;" />.

* **Click** on the <img src="../img/button/++.jpg" style="max-width:20px;"/> button to add a second condition.
...
<p align = "center" ><img src="../img/attributes-table/attribute-filter-4.jpg" style="max-width:620px;"/></p>

* **Click** on the loop icon to search <img src="../img/button/loop.jpg" style="max-width:20px;"/>.

As displayed in the picture below, the filter will return 20 records:

<p align = "center" ><img src="../img/attributes-table/attribute-filter-6.jpg" style="max-width:620px;"/></p>
...
<p align = "center" ><img src="../img/attributes-table/attribute-filter-7.jpg" style="max-width:620px;"/></p>

* **Click** on the loop icon to search <img src="../img/button/loop.jpg" style="max-width:20px;"/>.

The filter will return 7 records:

<p align = "center" ><img src="../img/attributes-table/attribute-filter-8.jpg" style="max-width:620px;"/></p>
...
<p align = "center" ><img src="../img/attributes-table/geometry-filter.jpg" style="max-width:620px;"/></p>

* **Select** the *Filter Type*, e.g. Circle.
* **Draw** the circle on the map; eventually you can change the position of the center and the radius by clicking on the icon <img src="../img/button/edit-icon-1.jpg" style="max-width:30px;"/>.
* **Set** the *Geometric Operation*, e.g.Contains.

<p align = "center" ><img src="../img/attributes-table/geometry-filter-1.jpg" style="max-width:700px;"/></p>

* **Click** on the loop icon to apply the filter <img src="../img/button/loop.jpg" style="max-width:20px;"/>.

<p align = "center" ><img src="../img/attributes-table/geometry-filter-2.jpg" style="max-width:600px;"/></p>
...
<p align = "center" ><img src="../img/attributes-table/layer-filter-1.jpg" style="max-width:600px;"/></p>

Let us suppose that we want to get all the Unesco sites in Sicily. To do it:


* **Select** the layer *Unseco Items*.
* **Click** on the *Open Attribute Table* icon <img src="../img/button/attributes-table.jpg" style="max-width:20px;"/>.
* **Click** on the *Advanced Search* icon <img src="../img/button/filter-icon.jpg" style="max-width:25px;" />.
...
<p align = "center" ><img src="../img/attributes-table/layer-filter-2.jpg" style="max-width:600px;"/></p>
...
<p align = "center" ><img src="../img/attributes-table/layer-filter-3.jpg" style="max-width:600px;"/></p>
