...
* Manage records through the <img src="../img/button/quit-edit-mode-button.jpg" class="ms-docbutton"/> button 
...
* Zoom to features through the <img src="../img/button/zoom-feature.jpg" class="ms-docbutton"/> button or zoom to the max extent through the <img src="../img/button/zoom_button.jpg" class="ms-docbutton"/> button 
