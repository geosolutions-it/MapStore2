...
!!! note
    The WMS layer legend is dynamically filtered according to the [Filter](filtering-layers.md#filter-types) applied to the layer and the bounding box corresponding to the current map extent.
