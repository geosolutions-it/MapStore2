...
- [ ] Increment version in `package.json`. (as for semantinc versioning the major have to be 0 until the npm package has not a stable API)
...
- [ ] Test on QA [http://qa-mapstore.geosolutionsgroup.com/mapstore/](http://qa-mapstore.geosolutionsgroup.com/mapstore/)
...
- [ ] Get the [latest mapstore.war](http://build.geo-solutions.it/jenkins/view/MapStore2/job/MapStore2-Releaser/ws/product/target/mapstore.war) from the Releaser Jenkins build 
