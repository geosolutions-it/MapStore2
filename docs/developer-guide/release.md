...
- [ ] Create a milestone on gtihub with the same name of the release (vYYYY.XX.xx)
    - [ ] create a label "current release" temporary and assing the label to all the issues of the current zenhub release
