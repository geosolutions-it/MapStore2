...
L.TileLayer.WMTS = L.TileLayer.extend({
    ...
    getTileUrl: function(tilePoint) { // (Point, Number) -> String
        ...
        console.log("this is the crs"+crs);
        console.log("map "+map);
        let tileSize = this.options.tileSize;
        console.log("tlsize "+tileSize);
